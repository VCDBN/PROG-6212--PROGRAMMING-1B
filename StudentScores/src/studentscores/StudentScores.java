...
public class StudentScores {
    public static void main(String[] args) {
        // Define a 2D array to store student information (3 students and 3 subjects)
        String[][] studentData = new String[3][4]; // 3 students, 4 columns (name, math score, english score, science score)
