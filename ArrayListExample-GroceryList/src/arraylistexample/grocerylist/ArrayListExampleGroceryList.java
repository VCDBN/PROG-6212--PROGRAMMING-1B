...
public class ArrayListExampleGroceryList {
    ...
    public static void main(String[] args) {
         ...
         //The ArrayList is your container where you will add,remove and manage your strings easily
         
        ArrayList<String> groceryList = new ArrayList<>();  // Create an ArrayList to store grocery items
